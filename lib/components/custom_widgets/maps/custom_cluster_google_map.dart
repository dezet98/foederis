...
class CustomClusterGoogleMap extends StatefulWidget {
  ...
  @override
  _CustomClusterGoogleMapState createState() => _CustomClusterGoogleMapState();
}

class _CustomClusterGoogleMapState extends State<CustomClusterGoogleMap> {
